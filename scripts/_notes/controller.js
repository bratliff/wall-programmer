...
if (playing === undefined) {
   ...
   savedProgramArray = ["bolt", "copyCat", "livingArt"];
   intervalArray = ["60", "60", "60"];
   playing = 0;
}  else {
...
var newIndex = getCookie("CurrentIndex");
var presentIndex = $("li.playing").index();
console.log("Playing: " + presentIndex + ", Cookie index: " + newIndex, ", Program Length: " + $(".addedProgram").length);


}

setInterval(checkPlaying,4000);
